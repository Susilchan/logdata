    ...
    <html>
        ...
        <body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <nav class="main-nav">
                                    ...
                                    <a href='<?php $baseURL ?>/h31'><button class="bt active"> <img src="asset/Icon-Grafik.png" alt="grafik" class="responsive" width="50px" height="50px"></a>
                                    <a href='<?php $baseURL ?>/h41'><button class="bt"> <img src="asset/Icon-Tables.png" alt="table" class="responsive" width="50px" height="50px"></a>
                ...
                <div class="button-blok">
                    ...
                    <a href='<?php $baseURL ?>/h33'><button class="button-b active">BLOK 3</button></a>
